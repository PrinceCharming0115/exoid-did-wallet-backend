...
export const createVerificationCodeHandler = async (
  ...
  tempDate.setMinutes(tempDate.getMinutes() + VERIFICATION_CODE_EXPIRATION_TIME);
...
export const createVerificationCode = errorHandlerWrapper(createVerificationCodeHandler);
